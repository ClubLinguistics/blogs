...
![]({{ site.baseurl }}/images/table_1_to_upload.png "Source: 'Understanding Confusion matrix and applying it on KNN-Classifier on Iris Data set' by Vishwanath Beena on medium")
...
![]({{ site.baseurl }}/images/table_2_to_upload.png) 
...
![]({{ site.baseurl }}/images/Fig_1_to_upload.png)
...
![]({{ site.baseurl }}/images/Fig_2_to_upload.png)
