...
toc: false
layout: post
description: Principal component analysis (PCA) is to find the subset of variables that best explains the variation in the data.
categories: [machine learning]
hide: false
comments: true
image: images/pca_fig_1.jpeg
...
![]({{ site.baseurl }}/images/pca_fig_1.jpeg "Source : An Introduction to Statistical Learning with Applications in R ,book by Robert Tibshirani, Gareth James, Trevor Hastie, Daniela Witten")
...
![]({{ site.baseurl }}/images/pca_fig_2.jpeg "Source : An Introduction to Statistical Learning with Applications in R ,book by Robert Tibshirani, Gareth James, Trevor Hastie, Daniela Witten")
...
![]({{ site.baseurl }}/images/pca_fig3.jpeg "Source : An Introduction to Statistical Learning with Applications in R ,book by Robert Tibshirani, Gareth James, Trevor Hastie, Daniela Witten")
